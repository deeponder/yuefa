...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/yuefa/Public/Admin/css/login.css?v=<?php echo SITE_VERSION;?>" media="all">
       	<link rel="stylesheet" type="text/css" href="/yuefa/Public/Admin/css/<?php echo (C("COLOR_STYLE")); ?>.css?v=<?php echo SITE_VERSION;?>" media="all">
    </head>
    <body id="login-page">
        <div id="main-content">
